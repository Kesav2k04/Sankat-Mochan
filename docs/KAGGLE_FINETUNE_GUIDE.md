...
python -m qai_hub_models.models.<gemma_4_e2b_recipe>.quantize \
    --checkpoint ./sahayak-e2b/merged-16bit -o ./quantized
python -m qai_hub_models.models.<gemma_4_e2b_recipe>.export \
...
- **Verify tonight (5 min):** `pip install qai-hub-models` then
  ...
  lists Gemma-4-E2B-it (and E4B); the bring-your-own-weights tutorial was written for Llama).
