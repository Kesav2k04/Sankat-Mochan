"""One-shot: extract a Wayanad-area vector basemap from the remote Protomaps v4
daily build into a local PMTiles archive (offline demo tiles for the sim/).
...
(https://github.com/protomaps/PMTiles, BSD-3). Run from command-post/ with the venv.
"""
import io
import math
import sys
...
OUT = "static/wayanad.pmtiles"

# Wayanad box (~0.40° x 0.35°, same footprint as the Bengaluru extract). Covers the
# sim's 10 km danger zone (ZONE 11.685/76.132), OUTPOST (11.635/76.225) and
# DANGER_SPOT (11.6995/76.0605) in sim/src/sim/lora.js with comfortable margin.
MIN_LON, MAX_LON = 75.95, 76.35
MIN_LAT, MAX_LAT = 11.50, 11.85
MINZOOM, MAXZOOM = 0, 15
CENTER_LON, CENTER_LAT, CENTER_Z = 76.132, 11.685, 12
